...
namespace Azure.Tables.ConsoleApp1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            //Diferencia entre TableServiceClient y TableClient:
            //El cliente del servicio nos permite interactuar con la tabla y el cliente tabla interactua con los datos almacenados en las tablas.
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            // Listado productos con precio igual o mayor a 2
            var resultado2 = clientTables.Query<Producto2>("precio ge 2"); // ge = GreaterEqual (>=)
            Console.WriteLine($"Productos con precio >= 2:");
            foreach (var item in resultado2) Console.WriteLine($"{item.RowKey}# {item.descripcion}");

            // Listado productos con precio igual o mayor a 2 con LINQ
